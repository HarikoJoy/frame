...
public class CountByModelSelectivePlugin extends MyBatisPlugin {
	private static final String SELECT_COUNT_BY_MODEL_SELECTIVE_METHOD_NAME = "countByModelSelective";
	...
	private void genSelectCountByModelSelectiveMethod(Interface interfaze, TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
		String modelName = introspectedTable.getTableConfiguration().getDomainObjectName();

		getClass();
		Method method = new Method(SELECT_COUNT_BY_MODEL_SELECTIVE_METHOD_NAME);
	...
	private void genSelectCountByModelSql(Document document, IntrospectedTable introspectedTable) {
		...
		getClass();
		Attribute attribute = new Attribute("id", "countByModelSelective");
